...
client = MlflowClient()  #probably some legacy bullshit  use or sometimes use mlflow, when who knows??
...
display(client.search_runs(experiment_ids="171515314b05466a88fb67ee90fa05c7"))

# COMMAND ----------

display(mlflow.search_runs(experiment_ids="171515314b05466a88fb67ee90fa05c7"))
